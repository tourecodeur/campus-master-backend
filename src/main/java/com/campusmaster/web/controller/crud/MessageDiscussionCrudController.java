...
import com.campusmaster.web.dto.crud.MessageDiscussionRequest;
...
public class MessageDiscussionCrudController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<MessageDiscussion> modifier(@PathVariable Long id, @RequestBody MessageDiscussionRequest req) {
