...
import com.campusmaster.application.service.ServiceDiscussion;
import com.campusmaster.application.service.ServiceMessageriePrivee;
...
public class MessagerieController {
    ...
    public ResponseEntity<MessagePrive> envoyerPrive(@RequestParam Long destinataireId,
        ...
        return ResponseEntity
                .ok(serviceMessageriePrivee.envoyerMessage(expediteurId, destinataireId, contenu, "PRIVE"));
    }
        ...
        if (!currentUserService.isAdmin()) {
            ...
            if (!me.equals(u1) && !me.equals(u2)) {
                throw new org.springframework.security.access.AccessDeniedException(
                        "Accès interdit : conversation d'autres utilisateurs");
            }
        }
